...
export const PROCEDURES_DIVISION = `Además de la integración de expedientes de trámites de registro sanitario de insumos 
para la salud, realizamos cualquier tipo de notificación y/o autorización sanitaria establecimientos o productos que
requiera su empresa.`;

export const TECHNICAL_SCIENTIFIC_TRAN_DIVISION = `Traducciones de inglés a español y viceversa de cualquier texto 
